...
if not defined PYTHON_CMD if exist "E:\Nanobot\.venv\Scripts\python.exe" set "PYTHON_CMD=E:\Nanobot\.venv\Scripts\python.exe"
...
echo 如果已在 E:\Nanobot 部署，请检查 E:\Nanobot\.venv\Scripts\python.exe 是否存在。
pause
exit /b 1
